...
// websearch, webfetch. Write tools: create_page, update_page, patch_page,
// delete_page, link_pages, move_page. ask_user: ask_user. load_skill:
// load_skill (progressive-disclosure skill loader, no side effects).
